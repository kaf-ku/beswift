...
document.getElementById('checkbtn').addEventListener("click", () => {
  ...
  if (inputValue == randomNum) {
    ...
    [guess.textContent, input.disabled, guess.style.color] = ["Congratulations", true, "#B8C6DC"];
    [checkButton.textContent, guess.style.color] = ["Replay", "B8C6DC"];
